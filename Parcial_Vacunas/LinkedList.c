...
/** \brief Devuelve un nuevo LinkedList cargado con los elementos que pasan la funcion de mapeo
 *
 * \param LinkedList* this LinkedList a mapear
 * \param int (*pFunc) (void*) Puntero a funcion map
 * \return nuevo puntero a LinkedList
 *
 */
